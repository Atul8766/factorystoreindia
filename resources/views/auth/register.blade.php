                    ...
                    <div class="row">
                        <div
                            ...
                            <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center"
                                style="background-image: url('{{ asset('public/assets/img/illustrations/illustration-signup.jpg') }}'); background-size: cover;">
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <form id="registration-form" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="input-group input-group-outline mb-3">
                                            ...
                                            <input id="pan_card_id" type="text"
                                                class="form-control @error('pan_card_id') is-invalid @enderror"
                                                name="pan_card_id" value="{{ old('pan_card_id') }}"
                                                autocomplete="pan_card_id" autofocus>

                                        </div>
                                        <div class="input-group-append mt-2">
                                            <span class="error text-danger" id="pan_card_id-error"
                                                role="alert"></span>
                                        </div>
                                        ...
                                        <div class="input-group input-group-outline mb-3">
                                            ...
                                            <input id="upi_id" type="text"
                                                ...
                                                name="upi_id" value="{{ old('upi_id') }}" autocomplete="upi_id"
                                                autofocus>
                                        ...
                                        <div class="input-group input-group-outline mb-3">
                                            <input id="generated-code" name="code" type="text"
                                                class="form-control" readonly>
                                        </div>

                                        <div class="input-group input-group-outline mb-3">
                                            <button type="button" id="generate-code-button"
